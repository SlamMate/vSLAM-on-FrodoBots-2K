...
int main(int argc, char **argv)
{
    if(argc != 4)
    {
        cerr << endl << "Usage: ./mono_custom path_to_vocabulary path_to_settings path_to_sequence" << endl;
        return 1;
    }
    ...
    if(!cap.isOpened())
    {
        cerr << "Failed to open video file: " << videoFilePath << endl;
        return 1;
    }
    ...
    cout << "Frames in the sequence: " << nFrames << endl << endl;
    ...
    for(int ni=0; ni<nFrames; ni++)
    {
        ...
        if(im.empty())
        {
            cerr << "Failed to load frame at: " << ni << endl;
            break;
        }
